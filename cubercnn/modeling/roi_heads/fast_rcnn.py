...
def fast_rcnn_inference_single_image(
    ...
    # final_scores_full = []
    # for i in range(scores_full.shape[0]):
    #     class_index = filter_inds[i, 1]
    #     final_scores_full.append(scores_full[i, class_index].item())
    
    # final_scores_full = torch.tensor(final_scores_full)
